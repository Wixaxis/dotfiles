...
After installing wob, the volume OSD script (`~/scripts/volume-osd.sh`) will automatically use wob instead of notifications. That script is provided by the shared `scripts` package.
