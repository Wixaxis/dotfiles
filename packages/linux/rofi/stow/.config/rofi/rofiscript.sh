...
ROFIMENU_THEME="$HOME/.local/share/rofi/themes/nord-sidebar-wixaxis.rasi"		# theme file that defines menu look
...
# ROFIMENU_THEME="$HOME/.local/share/rofi/themes/nord-sidebar-wixaxis.rasi"
_EOF_
fi
